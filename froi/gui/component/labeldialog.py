...
class LabelDialog(QDialog, DrawSettings):
    ...
    def _init_gui(self):
        ...
        grid_layout.addWidget(color_label, 0, 0)
        grid_layout.addWidget(self.color_button, 0, 1)
    ...
    def _update_color(self, s):
        s = str(s)
        if s:
            self.color_button.set_current_color(self._label_config.get_current_label_color(s))
